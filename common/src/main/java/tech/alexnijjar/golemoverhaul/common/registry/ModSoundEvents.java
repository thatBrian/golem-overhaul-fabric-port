...
public class ModSoundEvents {
    ...
    public static final RegistryEntry<SoundEvent> COAL_GOLEM_AMBIENT = SOUND_EVENTS.register("coal_golem_ambient", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "coal_golem_ambient")));

    public static final RegistryEntry<SoundEvent> COAL_GOLEM_HURT = SOUND_EVENTS.register("coal_golem_hurt", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "coal_golem_hurt")));

    public static final RegistryEntry<SoundEvent> COAL_GOLEM_DEATH = SOUND_EVENTS.register("coal_golem_death", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "coal_golem_death")));

    public static final RegistryEntry<SoundEvent> COAL_GOLEM_EXPLODE = SOUND_EVENTS.register("coal_golem_explode", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "coal_golem_explode")));

    public static final RegistryEntry<SoundEvent> BARREL_GOLEM_BARTER = SOUND_EVENTS.register("barrel_golem_barter", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "barrel_golem_barter")));

    public static final RegistryEntry<SoundEvent> NETHERITE_GOLEM_HIT = SOUND_EVENTS.register("netherite_golem_hit", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "netherite_golem_hit")));

    public static final RegistryEntry<SoundEvent> NETHERITE_GOLEM_HURT = SOUND_EVENTS.register("netherite_golem_hurt", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "netherite_golem_hurt")));

    public static final RegistryEntry<SoundEvent> NETHERITE_GOLEM_DEATH = SOUND_EVENTS.register("netherite_golem_death", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "netherite_golem_death")));

    public static final RegistryEntry<SoundEvent> NETHERITE_GOLEM_STEP = SOUND_EVENTS.register("netherite_golem_step", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "netherite_golem_step")));

    public static final RegistryEntry<SoundEvent> NETHERITE_GOLEM_SUMMON = SOUND_EVENTS.register("netherite_golem_summon", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "netherite_golem_summon")));

    public static final RegistryEntry<SoundEvent> HAY_GOLEM_HURT = SOUND_EVENTS.register("hay_golem_hurt", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "hay_golem_hurt")));

    public static final RegistryEntry<SoundEvent> HAY_GOLEM_DEATH = SOUND_EVENTS.register("hay_golem_death", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "hay_golem_death")));

    public static final RegistryEntry<SoundEvent> KELP_GOLEM_DEATH = SOUND_EVENTS.register("kelp_golem_death", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "kelp_golem_death")));

    public static final RegistryEntry<SoundEvent> KELP_GOLEM_STEP = SOUND_EVENTS.register("kelp_golem_step", () ->
        SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(GolemOverhaul.MOD_ID, "kelp_golem_step")));
}
